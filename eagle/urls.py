...
urlpatterns = [
    ...
    path('user-details/<int:user_id>/', views.user_details, name='user_detail'),
    path('api/user-details/', views.user_details_api, name='user_details_api'),
    path('api/user-details/<int:user_id>/', views.user_details_api, name='user_detail_api'),
